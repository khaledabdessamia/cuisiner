    ...
    ?>
                <div class="row">
                    <div class="col-md-12 p-2">
                        ...
                        <p class="lead">
                            Si vous voulez plus d'informations ou que vous voulez nous contacter à propos d'un sujet bien précis, ou bien pour avoir un retour de notre support clientèle, veuillez saisir vos informations dans l'un des formulaires suivants
                        </p>

                        <hr class="tall p-4 mt-5">
                    </div>
                </div>
                <div class="row">
                    <!-- Sidebars -->
                    <div class="col-md-4 sidebars contact-sidebar p-3">

                        <aside class="border-right py-5 px-2">
                            ...
                            <address>
                              ...
                              <i class="fa fa-fax"></i> <abbr title="Phone">Fax:</abbr> +213 23 384 421                            </span></address>
